...
import beast9.com.recyclerview.DetalleContacto;
...
public class MascotaAdapter extends RecyclerView.Adapter<MascotaAdapter.MascotaViewHolder>{
    ...
    public void onBindViewHolder(final MascotaViewHolder holder, int position) {
        ...
        holder.tvRai.setText(String.valueOf(mascota.getLikes()) + "Likes");

        holder.fotoMascota.setOnClickListener(new View.OnClickListener() {
            @Override
